...
class LecteurVideo(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ouvrir_button.triggered.connect(self.ouvrir_video)
    ...
    def ouvrir_video(self):
        """ouvrir a video file and set it as the media for the media player."""
    ...
    def liste_chaine(self):
        pass
        # chaines = ["TF1", "France 2", "France 3", "Canal+", "M6", "Arte"]
        # print("Choisissez une chaîne :")
        # for i, chaine in enumerate(chaines):
        #     print(f"{i+1}. {chaine}")
        # choix = int(input("Entrez le numéro de la chaîne : "))
        # chaine_selectionnee = chaines[choix-1]
        # print(f"Vous avez choisi la chaîne {chaine_selectionnee}.")
...
from PyQt5 import QtCore, QtGui, QtWidgets, QHBoxLayout, QComboBox, QPushButton
from PyQt5.QtMultimedia import QMediaContent, QMediaPlayer
from PyQt5.QtMultimediaWidgets import QVideoWidget

class config_chaines(QWidget):
    def __init__(self, parent=None):
        super(config_chaines, self).__init__(parent)
